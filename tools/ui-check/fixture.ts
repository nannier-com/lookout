  ...
  const backlog = {
        ...
        findings: {
          ...
          "app.settings.rest.desktop.dark.layout-overflow.horizontal-scroll": finding({
            ...
            status: "fixed",
            fixedIn: { commit: "9f2c41d7b6a8e05c3d1f7e6d5c4b3a2918070605", runId: "verify-fix-1", at: AT },
        ...
        issues: {
          ...
          [SIBLING_ISSUE]: {
            ...
            acceptance: [],
            causedBy: { issue: STILL_OPEN_ISSUE, commit: "9f2c41d7b6a8e05c3d1f7e6d5c4b3a2918070605", runId: "verify-fixture-2", at: ATTEMPT_2_AT },
          },
        },
    ...
    JSON.stringify(
      {
        ...
        attempts: [
          ...
          },
          {
            ...
            reported: {
              commit: "9f2c41d7b6a8e05c3d1f7e6d5c4b3a2918070605",
            ...
            observed: {
              head: "9f2c41d7b6a8e05c3d1f7e6d5c4b3a2918070605",
              dirty: false,
