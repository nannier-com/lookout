 ...
 *     shots/            generated: the screenshots it was filed against
 *     state.json        truth: attempts, written by verify-fix
 *     recheck/          truth: what the last verify-fix saw afterwards
...
import { flatShotName, issueDir, issueShotsDir } from "./paths.js";
import { renderIssueDocument } from "./document.js";
import type { ResolvedConfig } from "../types.js";

/** One screenshot as the dossier records it. */
export interface IssueShot {
  /** Filename inside shots/, flattened from the evidence-relative path. */
  file: string;
  route: string;
  formFactor: string;
  scheme: string;
...
const GENERATED =
  ...
  "state.json and recheck/ in this folder are NOT generated and are never rewritten.";
...
async function syncShots(resolved: ResolvedConfig, id: string, cluster: FixCluster): Promise<IssueShot[]> {
  ...
  const dir = issueShotsDir(resolved, id);
